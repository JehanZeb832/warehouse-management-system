  ...
  <!-- search methode start -->
          ...
          <div id="allSearchMethods" class="box-body" style="border: 1px solid #ebedef;">
              ...
              <div class="col-md-2 " id="form-submit-btn" style="margin-top: 30px;">
                <div class="form-group">
                  <input type="submit" id="search_purchase_report" class="btn btn-primary rounded-0" value="Show">
                </div>
			 </div>
              </div>
		</div>
...
<script>
 ...
 var customer = 	$("#customer option:selected" ).val();
    ...
    $.post('app/ajax/search_purchase_report.php', {customer:customer,issuedate:issuedate}, function(data) {
