      ...
      <form id="editProduct">
       ...
       <div class="col-md-4 col-lg-4">
          ...
          <select name="product_source" id="product_source" class="form-control select2">
            ...
            <option <?php if ($data->product_source == 'local'){echo "selected";}else{echo "";} ?> value="local">Local</option>s
          </select>
         </div>
       </div>
        <div class="col-md-4 col-lg-4">
       ...
       <div class="col-md-4 col-lg-4">
         <div class="form-group">
          ...
          <input type="number" class="form-control" value="<?=$data->buy_price;?>" name="buy_price">
        </div>
       </div>
        <div class="col-md-4 col-lg-4">
         <div class="form-group">
